...
```bash
python3 blacksmith_xla/experiments/torch/vit/train.py --config blacksmith_xla/experiments/torch/vit/single_chip/vit_stanfordcars.yaml
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_xla/experiments/torch/vit" |
