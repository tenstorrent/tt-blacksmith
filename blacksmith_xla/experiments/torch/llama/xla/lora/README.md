...
SST2 dataset:
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/single_chip/llama_3_2_1b_sst2.yaml
```

Alpaca dataset:
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/single_chip/llama_3_2_1b_alpaca.yaml
```

**QuietBox Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/quietbox/llama_3_2_1b_sst2.yaml
```

**Galaxy Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/galaxy/llama_3_2_1b_sst2.yaml
```
...
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/single_chip/llama_3_2_3b_fusechat.yaml
```

**QuietBox Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/quietbox/llama_3_2_3b_fusechat.yaml
```
...
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/single_chip/llama_3_1_8b_sst2.yaml
```

**QuietBox Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/quietbox/llama_3_1_8b_sst2.yaml
```
...
**Galaxy Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/galaxy/llama_3_1_8b_sst2.yaml
```
...
**QuietBox Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/quietbox/llama_3_1_8b_instruct_metamathqa.yaml
```
...
**LoudBox Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/loudbox/llama_3_1_70b_sst2.yaml
```

**Galaxy Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/galaxy/llama_3_1_70b_sst2.yaml
```
...
**LoudBox Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/loudbox/llama_3_3_70b_instruct_alpaca.yaml
```

**Galaxy Training:**
```bash
python3 blacksmith_xla/experiments/torch/llama/xla/train.py --config blacksmith_xla/experiments/torch/llama/xla/lora/galaxy/llama_3_3_70b_instruct_alpaca.yaml
```
...
| `project_dir`                 | Directory for experiment outputs.                      | "blacksmith_xla/experiments/torch/qwen" |
