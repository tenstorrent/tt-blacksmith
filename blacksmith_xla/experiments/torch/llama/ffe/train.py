...
from blacksmith_xla.experiments.torch.llama.ffe.utils import TextModelWrapper, get_model
...
def train(config, model, tokenizer, train_data_loader, val_data_loader):
    ...
    if config.use_tt:
        ...
        from blacksmith_xla.experiments.torch.llama.ffe.loss import CrossEntropyLoss
