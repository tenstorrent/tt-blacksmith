...
The agent uses a CNN architecture from `blacksmith_xla/models/torch/BOUNTIES/ppo_breakout/model.py` with standard Atari preprocessing wrappers.
...
```bash
python blacksmith_xla/experiments/torch/BOUNTIES/ppo_breakout/train.py
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_xla/experiments/torch/BOUNTIES/ppo_breakout" |
