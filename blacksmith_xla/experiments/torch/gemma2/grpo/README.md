...
```bash
python3 blacksmith_xla/experiments/torch/gemma2/grpo/train.py --config blacksmith_xla/experiments/torch/gemma2/grpo/single_chip/gemma2_gsm8k_grpo.yaml
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_xla/experiments/torch/gemma2/grpo" |
