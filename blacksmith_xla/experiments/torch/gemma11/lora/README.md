...
SST2 dataset:
```bash
python3 blacksmith_xla/experiments/torch/gemma11/lora/train.py --config blacksmith_xla/experiments/torch/gemma11/lora/single_chip/gemma11_sst2.yaml
```

SQuAD V2 dataset:
```bash
python3 blacksmith_xla/experiments/torch/gemma11/lora/train.py --config blacksmith_xla/experiments/torch/gemma11/lora/single_chip/gemma11_squadV2.yaml
```

Math preference (SFT) dataset:
```bash
python3 blacksmith_xla/experiments/torch/gemma11/lora/train.py --config blacksmith_xla/experiments/torch/gemma11/lora/single_chip/gemma11_math_preferences_sft.yaml
```

### QuietBox Training

```bash
python3 blacksmith_xla/experiments/torch/gemma11/lora/train.py --config blacksmith_xla/experiments/torch/gemma11/lora/quietbox/gemma11_math_preferences_sft.yaml
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_xla/experiments/torch/gemma11" |
