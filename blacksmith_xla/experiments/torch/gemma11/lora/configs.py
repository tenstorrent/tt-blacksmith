...
from blacksmith_xla.tools.templates.configs import TrainingConfig as BaseTrainingConfig
from blacksmith_xla.tools.test_config import TestConfig
...
class TrainingConfig(BaseTrainingConfig):
    ...
    wandb_project: str = Field(default="gemma11-finetuning")
    wandb_run_name: str = Field(default="tt-gemma11-sst2")
    ...
    project_dir: str = Field(default="blacksmith_xla/experiments/torch/gemma11")
