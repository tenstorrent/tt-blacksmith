...
```bash
python3 blacksmith_xla/experiments/torch/gemma11/dpo/train.py --config blacksmith_xla/experiments/torch/gemma11/dpo/single_chip/gemma11_math_preferences_dpo.yaml
```

### QuietBox Training

```bash
python3 blacksmith_xla/experiments/torch/gemma11/dpo/train.py \
  --config blacksmith_xla/experiments/torch/gemma11/dpo/quietbox/gemma11_math_preferences_dpo.yaml \
  --reference-model-checkpoint-path blacksmith_xla/experiments/torch/gemma11/lora/checkpoints/<SFT_CHECKPOINT>.pt
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_xla/experiments/torch/gemma11/dpo" |
