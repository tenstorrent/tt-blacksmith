...
```bash
python3 blacksmith_xla/experiments/lightning/mnist/train.py
```
...
In `blacksmith_xla/experiments/lightning/mnist/mnist.yaml` you can for example change loss to be on cpu or pick some other loss that forge-fe have to offer.
