...
from blacksmith_xla.experiments.lightning.mnist.configs import ExperimentConfig
from blacksmith_xla.models.torch.mnist.mnist_linear import MNISTLinear
from blacksmith_xla.tools.cli import generate_config
from blacksmith_xla.tools.forge_tooling import disable_forge_logger
from blacksmith_xla.tools.torch_lightning import (
    GradientCheckpoint,
...
def test_training():
    ...
    config: ExperimentConfig = generate_config(ExperimentConfig, "blacksmith_xla/experiments/lightning/mnist/mnist.yaml")
