...
```bash
python3 blacksmith/experiments/lightning/mnist/mnist_lightning_ffe.py
```
...
In `blacksmith/experiments/lightning/mnist/mnist_lightning_ffe.yaml` you can for example change loss to be on cpu or pick some other loss that forge-fe have to offer.
