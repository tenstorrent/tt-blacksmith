...
```bash
python3 blacksmith/experiments/torch/qwen/qwen_finetuning.py --config blacksmith/experiments/torch/qwen/single_chip/qwen_finetuning_text2sql.yaml
```
...
| ------------------ | ---------- | --------------- | ------- | ------ |
| [Single-Chip](single_chip/qwen_finetuning_text2sql.yaml)        | None       | None            | Text2SQL    | LoRA   |
...
**Single Chip Training:**
```bash
python3 blacksmith/experiments/torch/qwen/qwen_finetuning.py --config blacksmith/experiments/torch/qwen/single_chip/qwen_1-5b_finetuning_text2sql.yaml
```
...
| Architecture       | mesh_shape | mesh_axis_names | dataset | Method |
| ------------------ | ---------- | --------------- | ------- | ------ |
| [Single-Chip](single_chip/qwen_1-5b_finetuning_text2sql.yaml)        | None       | None            | Text2SQL    | LoRA   |
...
**Single Chip Training:**
```bash
python3 blacksmith/experiments/torch/qwen/qwen_finetuning.py --config blacksmith/experiments/torch/qwen/single_chip/qwen_3_4b_instruct_2507_finetuning_sst2.yaml
```

**Blackhole QuietBox Training:**
```bash
python3 blacksmith/experiments/torch/qwen/qwen_finetuning.py --config blacksmith/experiments/torch/qwen/quietbox/qwen_3_4b_instruct_2507_finetuning_sst2.yaml
```
...
| Architecture       | mesh_shape         | mesh_axis_names                           | dataset | Method |
| ------------------ | -----------------  | ----------------------------------------- | ------- | ------ |
| [Single-Chip](single_chip/qwen_3_4b_instruct_2507_finetuning_sst2.yaml)        | None               | None                                      | SST2    | LoRA   |
| [N300](quietbox/qwen_3_4b_instruct_2507_finetuning_sst2.yaml)             | `[1, 2]`, `[2, 1]` |  `["data", "model"]`, `["model", "data"]` | SST2    | LoRA   |
| [Blackhole QuietBox](quietbox/qwen_3_4b_instruct_2507_finetuning_sst2.yaml) | `[1, 4]`           | `["data", "model"]`                       | SST2    | LoRA   |
...
**Galaxy Training:**
```bash
python3 blacksmith/experiments/torch/qwen/qwen_finetuning.py --config blacksmith/experiments/torch/qwen/galaxy/qwen_3_8b_base_finetuning_sst2.yaml
```
...
| Architecture       | mesh_shape         | mesh_axis_names                           | dataset | Method |
| ------------------ | -----------------  | ----------------------------------------- | ------- | ------ |
| [Wormhole Galaxy](galaxy/qwen_3_8b_base_finetuning_sst2.yaml)        | `[8, 4]`   | `["data", "model"]`, `["model", "data"]` | SST2    | LoRA   |
...
```bash
python3 blacksmith/experiments/torch/qwen/qwen_finetuning.py --config blacksmith/experiments/torch/qwen/quietbox/qwen_3_8b_finetuning_alpaca.yaml
```
...
| Architecture       | mesh_shape         | mesh_axis_names                           | dataset | Method |
| ------------------ | -----------------  | ----------------------------------------- | ------- | ------ |
| [Wormhole QuietBox](quietbox/qwen_3_8b_finetuning_alpaca.yaml)        | `[1, 8]`, `[8, 1]`, `[2, 4]` | `["batch", "model"]`, `["model", "batch"]` | Alpaca    | LoRA   |
...
**Galaxy Training:**
```bash
python3 blacksmith/experiments/torch/qwen/qwen_finetuning.py --config blacksmith/experiments/torch/qwen/galaxy/qwen_3_32b_finetuning_alpaca.yaml
```
...
| Architecture       | mesh_shape         | mesh_axis_names                           | dataset | Method |
| ------------------ | -----------------  | ----------------------------------------- | ------- | ------ |
| [Wormhole Galaxy](galaxy/qwen_3_32b_finetuning_alpaca.yaml)        | `[8, 4]`   | `["model", "batch"]` | Alpaca    | LoRA   |
