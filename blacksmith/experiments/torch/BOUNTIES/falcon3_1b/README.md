...
```bash
python3 blacksmith/experiments/torch/BOUNTIES/falcon3_1b/test_falcon3_finetuning.py --config blacksmith/experiments/torch/BOUNTIES/falcon3_1b/test_falcon3_finetuning_wikitext.yaml
```
