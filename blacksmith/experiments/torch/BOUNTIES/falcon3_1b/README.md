...
```bash
python3 blacksmith/experiments/torch/BOUNTIES/falcon3_1b/falcon3_finetuning.py --config blacksmith/experiments/torch/BOUNTIES/falcon3_1b/falcon3_finetuning_wikitext.yaml
```
