...
**QuietBox Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/quietbox/test_llama_3_2_1b_sst2.yaml
```

**Galaxy Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/galaxy/test_llama_3_2_1b_sst2.yaml
```
...
| [N300](quietbox/test_llama_3_2_1b_sst2.yaml) | `[1, 2]`, `[2, 1]`           | `["data", "model"]`, `["model", "data"]` | SST2    | LoRA   |
| [Wormhole QuietBox](quietbox/test_llama_3_2_1b_sst2.yaml) | `[1, 8]`, `[8, 1]`, `[2, 4]` | `["data", "model"]`, `["model", "data"]` | SST2    | LoRA   |
| [Blackhole QuietBox](quietbox/test_llama_3_2_1b_sst2.yaml) | `[1, 4]`                     | `["data", "model"]`                      | SST2    | LoRA   |
| [Galaxy](galaxy/test_llama_3_2_1b_sst2.yaml) | `[8, 4]`                     | `["data", "model"]`, `["model", "data"]` | SST2    | LoRA   |
...
**QuietBox Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/quietbox/test_llama_3_2_3b_sst2.yaml
```
...
| Architecture       | mesh_shape                   | mesh_axis_names      | dataset      | Method     |
| ------------------ | ---------------------------- | -------------------- | ------------ | ---------- |
| [Blackhole QuietBox](quietbox/test_llama_3_2_3b_sst2.yaml) | `[1, 4]`                     | `["data", "model"]`  | SST2         | LoRA       |
...
**QuietBox Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/quietbox/test_llama_3_1_8b_sst2.yaml
```
...
**Galaxy Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/galaxy/test_llama_3_1_8b_sst2.yaml
```
...
| [Wormhole QuietBox](quietbox/test_llama_3_1_8b_sst2.yaml) | `[1, 8]`   | `["data", "model"]`                      | SST2    | LoRA   |
| [Wormhole QuietBox](quietbox/test_llama_3_1_8b_sst2.yaml) | `[8, 1]`   | `["model", "data"]`                      | SST2    | LoRA   |
| [Wormhole QuietBox](quietbox/test_llama_3_1_8b_sst2.yaml) | `[2, 4]`   | `["data", "model"]`                      | SST2    | LoRA   |
| [Blackhole QuietBox](quietbox/test_llama_3_1_8b_sst2.yaml) | `[1, 4]`   | `["data", "model"]`                      | SST2    | LoRA   |
| [Galaxy](galaxy/test_llama_3_1_8b_sst2.yaml) | `[8, 4]`   | `["data", "model"]`, `["model", "data"]` | SST2    | LoRA   |
...
**LoudBox Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/loudbox/test_llama_3_1_70b_sst2.yaml
```

**Galaxy Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/galaxy/test_llama_3_1_70b_sst2.yaml
```
...
| Architecture       | mesh_shape | mesh_axis_names                          | dataset | Method |
| ------------------ | ---------- | ---------------------------------------- | ------- | ------ |
| [Blackhole LoudBox](loudbox/test_llama_3_1_70b_sst2.yaml) | `[2, 4]`   | `["model", "batch"]`| SST2    | LoRA   |
| [Galaxy](galaxy/test_llama_3_1_70b_sst2.yaml) | `[4, 8]`   | `["model", "batch"]` | SST2    | LoRA   |
...
**LoudBox Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/loudbox/test_llama_3_3_70b_instruct_alpaca.yaml
```

**Galaxy Training:**
```bash
python3 blacksmith/experiments/torch/llama/xla/test_llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/lora/galaxy/test_llama_3_3_70b_instruct_alpaca.yaml
```
...
| Architecture       | mesh_shape | mesh_axis_names                          | dataset | Method |
| ------------------ | ---------- | ---------------------------------------- | ------- | ------ |
| [Blackhole LoudBox](loudbox/test_llama_3_3_70b_instruct_alpaca.yaml) | `[2, 4]`   | `["model", "batch"]`                      | Alpaca    | LoRA   |
| [Wormhole Galaxy](galaxy/test_llama_3_3_70b_instruct_alpaca.yaml) | `[4, 8]`   | `["model", "batch"]`                      | Alpaca    | LoRA   |
