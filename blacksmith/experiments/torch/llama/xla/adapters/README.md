...
```bash
python3 blacksmith/experiments/torch/llama/xla/llama_fine_tuning_pure_torch.py --config blacksmith/experiments/torch/llama/xla/adapters/adapters_sst2.yaml
```
