...
class TrainingConfig(BaseModel):
    ...
    # Model settings
    model_name: str = Field(default="gpt_oss_20b")
    ...
    lora_start_layer: int = Field(default=12, ge=0)  # layers [lora_start_layer, N_LAYERS) get LoRA

    # Device settings
    mesh_shape: Optional[list[int]] = Field(default=[1, 4])
    mesh_axis_names: Optional[list[str]] = Field(default=["batch", "model"])
