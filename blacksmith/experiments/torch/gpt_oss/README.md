...
**BH LoudBox Training:**
```bash
python3 blacksmith/experiments/torch/gpt_oss/test_gpt_oss_finetuning.py --config blacksmith/experiments/torch/gpt_oss/lora/loudbox/test_gpt_oss_20b_finetuning_sst2.yaml
```
...
| --- | --- | --- | --- | --- |
| [BH LoudBox](lora/loudbox/test_gpt_oss_20b_finetuning_sst2.yaml) | `[1, 8]` | `["batch", "model"]` | SST-2 | LoRA |
...
The experiment is configured using the configuration file `lora/loudbox/test_gpt_oss_20b_finetuning_sst2.yaml`. The
