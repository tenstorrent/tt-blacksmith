...
# Optional: JIT-compiled versions for performance
get_ray_directions_jit = jax.jit(get_ray_directions)
get_rays_jit = jax.jit(get_rays)
get_ndc_rays_jit = jax.jit(get_ndc_rays)
