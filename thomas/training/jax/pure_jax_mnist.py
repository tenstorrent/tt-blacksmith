...
from thomas.models.jax.mnist_linear import MNISTLinearConfig
...
def train_mnist():
    ...
    config: ExperimentConfig = generate_config(ExperimentConfig, "thomas/experiments/test_jax_mnist.yaml")
    ...
    def train_mlp(
        ...
        with jax.default_device(jax.devices("cpu")[0]):
            paramsh = init_mlp_params(key, input_size, hidden_size, output_size)
        ...
        for epoch in range(num_epochs):
            ...
            for i in range(num_batches):
                ...
                w1, b1, w2, b2, w3, b3 = update(params, x_batch, y_batch, learning_rate)
                ...
                if i % logger_config.log_every_n_steps == 0:
