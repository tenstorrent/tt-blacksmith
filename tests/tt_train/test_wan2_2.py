...
from blacksmith.models.tt_train.wan2_2.patch_embed import conv3d_weight_to_linear
from blacksmith.models.tt_train.wan2_2.weights import to_ttml_array
...
def test_gelu_tanh_matches_torch_both_directions():
    from blacksmith.models.tt_train.wan2_2.transformer import GeluTanh
...
def test_split_heads_matches_torch_both_directions():
    ...
    from blacksmith.models.tt_train.wan2_2.attention import SplitHeads
...
def _diffusers_block():
    from diffusers.models.transformers.transformer_wan import (
        WanTransformerBlock as TorchBlock,
    )
