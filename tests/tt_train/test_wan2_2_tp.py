...
nothing has already opened a device in this process, and every test in test_wan2_2.py does.
    ...
    TT_LOGGER_LEVEL=FATAL python_env/bin/python -m pytest \
        tests/tt_train/test_wan2_2_tp.py --tb=native -s
"""
...
def test_rmsnorm_tp_matches_torch_forward(mesh):
    ...
    from blacksmith.models.tt_train.wan2_2.attention import _RMSNorm
...
def _tp_attention():
    from blacksmith.models.tt_train.wan2_2 import WanConfig
    from blacksmith.models.tt_train.wan2_2.attention import WanAttention
...
def test_shard_plan_marks_exactly_the_parallel_parameters(mesh):
    ...
    from blacksmith.models.tt_train.wan2_2.weights import _shard_plan
...
def test_sharded_load_roundtrips_the_full_checkpoint_tensor(mesh):
    ...
    from blacksmith.models.tt_train.wan2_2.weights import _global_shape, _shard_plan
...
def test_tp_feedforward_matches_torch(mesh):
    ...
    """
    from blacksmith.models.tt_train.wan2_2 import WanConfig
    from blacksmith.models.tt_train.wan2_2.transformer import WanFeedForward
    from blacksmith.models.tt_train.wan2_2.weights import _global_shape, _shard_plan
...
def _lora_export():
    import blacksmith.models.tt_train.wan2_2.lora as mod

    return mod


def _tp_block():
    from blacksmith.models.tt_train.wan2_2 import WanConfig, WanTransformerBlock
...
def test_replicated_lora_gradients_agree_across_tp(mesh):
    ...
    """
    from blacksmith.models.tt_train.wan2_2 import build_rope_params
...
def test_conv3d_patch_embed_works_on_a_mesh(mesh):
    ...
    assert tuple(out.shape()) == (1, 1, 16, 64)
