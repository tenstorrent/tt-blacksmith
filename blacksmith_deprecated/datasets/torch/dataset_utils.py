...
from blacksmith_deprecated.datasets.torch.alpaca.alpaca_dataset import AlpacaDataset
from blacksmith_deprecated.datasets.torch.banking77.banking77_dataset import (
    Banking77Dataset,
)
from blacksmith_deprecated.datasets.torch.BOUNTIES.wikitext.wikitext_dataset import (
    WikitextDataset,
)
from blacksmith_deprecated.datasets.torch.custom.custom_llm_dataset import (
    CustomLLMDataset,
)
from blacksmith_deprecated.datasets.torch.fusechat.fusechat_dataset import (
    FuseChatDataset,
)
from blacksmith_deprecated.datasets.torch.gsm8k.gsm8k_dataset import GSM8KDataset
from blacksmith_deprecated.datasets.torch.mathpreference.math_preference_dataset import (
    MathDPODataset,
    MathSFTDataset,
)
from blacksmith_deprecated.datasets.torch.metamathqa.metamathqa_dataset import (
    MetaMathQADataset,
)
from blacksmith_deprecated.datasets.torch.mnist.mnist_dataset import MNISTDataset
from blacksmith_deprecated.datasets.torch.squadV2.squadV2_dataset import SquadV2Dataset
from blacksmith_deprecated.datasets.torch.sst2.sst2_dataset import SSTDataset
from blacksmith_deprecated.datasets.torch.stanfordcars.stanfordcars_dataset import (
    StanfordCarsDataset,
)
from blacksmith_deprecated.datasets.torch.text2sql.text2sql_dataset import (
    TextToSQLDataset,
)
from blacksmith_deprecated.datasets.torch.wizardlm_evol.wizardlm_evol_dataset import (
    WizardLMEvolDataset,
)
from blacksmith_deprecated.tools.templates.configs import TrainingConfig
...
def get_dataset(config: TrainingConfig, split: str = "train", collate_fn=None):
    ...
    if dataset_id == AvailableDataset.MNIST.value:
        ...
        from blacksmith_deprecated.datasets.torch.nerf.blender import BlenderDataset
