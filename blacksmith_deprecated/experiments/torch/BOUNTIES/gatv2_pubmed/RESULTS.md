...
CFG=blacksmith_deprecated/experiments/torch/BOUNTIES/gatv2_pubmed/single_chip

# CPU baseline (stock GATv2Conv)
python3 blacksmith_deprecated/experiments/torch/BOUNTIES/gatv2_pubmed/train.py

# TT (SpMM)
python3 blacksmith_deprecated/experiments/torch/BOUNTIES/gatv2_pubmed/train.py --config $CFG/gatv2_pubmed_tt.yaml
```
