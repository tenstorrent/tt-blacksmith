...
pip install -r blacksmith_deprecated/experiments/torch/BOUNTIES/gatv2_pubmed/requirements.txt
```
...
```bash
python3 blacksmith_deprecated/experiments/torch/BOUNTIES/gatv2_pubmed/train.py
```
...
```bash
python3 blacksmith_deprecated/experiments/torch/BOUNTIES/gatv2_pubmed/train.py \
  --config blacksmith_deprecated/experiments/torch/BOUNTIES/gatv2_pubmed/single_chip/gatv2_pubmed_tt.yaml
```
