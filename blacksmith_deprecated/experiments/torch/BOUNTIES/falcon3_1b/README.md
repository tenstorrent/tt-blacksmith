...
```bash
python3 blacksmith_deprecated/experiments/torch/BOUNTIES/falcon3_1b/train.py --config blacksmith_deprecated/experiments/torch/BOUNTIES/falcon3_1b/single_chip/falcon3_1b_wikitext.yaml
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_deprecated/experiments/torch/BOUNTIES/falcon3_1b" |
