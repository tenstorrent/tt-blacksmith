...
The agent uses a CNN architecture from `blacksmith_deprecated/models/torch/BOUNTIES/ppo_breakout/model.py` with standard Atari preprocessing wrappers.
...
```bash
python blacksmith_deprecated/experiments/torch/BOUNTIES/ppo_breakout/train.py
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_deprecated/experiments/torch/BOUNTIES/ppo_breakout" |
