...
```bash
python3 blacksmith_deprecated/experiments/torch/gemma/train.py
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_deprecated/experiments/torch/gemma" |
