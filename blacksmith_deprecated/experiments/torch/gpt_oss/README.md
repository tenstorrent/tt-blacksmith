...
**BH LoudBox Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/gpt_oss/train.py --config blacksmith_deprecated/experiments/torch/gpt_oss/lora/loudbox/gpt_oss_20b_sst2.yaml
```

**WH Galaxy Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/gpt_oss/train.py --config blacksmith_deprecated/experiments/torch/gpt_oss/lora/galaxy/gpt_oss_20b_alpaca.yaml
```
...
**WH Galaxy Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/gpt_oss/train.py --config blacksmith_deprecated/experiments/torch/gpt_oss/lora/galaxy/gpt_oss_120b_alpaca.yaml
```
...
| `project_dir` | Directory for experiment outputs. | `"blacksmith_deprecated/experiments/torch/gpt_oss"` |
