...
from blacksmith_deprecated.experiments.torch.gpt_oss.configs import TrainingConfig
from blacksmith_deprecated.models.torch.gpt_oss.model_overrides import get_model
...
if __name__ == "__main__":
    # Config setup
    default_config = Path(__file__).parent / "lora" / "loudbox" / "gpt_oss_20b_sst2.yaml"
