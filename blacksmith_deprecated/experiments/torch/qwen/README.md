...
```bash
python3 blacksmith_deprecated/experiments/torch/qwen/train.py --config blacksmith_deprecated/experiments/torch/qwen/single_chip/qwen_text2sql.yaml
```
...
**Single Chip Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/qwen/train.py --config blacksmith_deprecated/experiments/torch/qwen/single_chip/qwen_1-5b_text2sql.yaml
```
...
**Single Chip Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/qwen/train.py --config blacksmith_deprecated/experiments/torch/qwen/single_chip/qwen_3_4b_instruct_2507_sst2.yaml
```

**Blackhole QuietBox Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/qwen/train.py --config blacksmith_deprecated/experiments/torch/qwen/quietbox/qwen_3_4b_instruct_2507_sst2.yaml
```
...
**Galaxy Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/qwen/train.py --config blacksmith_deprecated/experiments/torch/qwen/galaxy/qwen_3_8b_base_sst2.yaml
```
...
```bash
python3 blacksmith_deprecated/experiments/torch/qwen/train.py --config blacksmith_deprecated/experiments/torch/qwen/quietbox/qwen_3_8b_alpaca.yaml
```
...
**Galaxy Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/qwen/train.py --config blacksmith_deprecated/experiments/torch/qwen/galaxy/qwen_3_32b_alpaca.yaml
```
