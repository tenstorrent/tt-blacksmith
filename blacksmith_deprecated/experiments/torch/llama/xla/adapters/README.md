...
```bash
python3 blacksmith_deprecated/experiments/torch/llama/xla/train.py --config blacksmith_deprecated/experiments/torch/llama/xla/adapters/single_chip/llama_3_2_1b_sst2.yaml
```
