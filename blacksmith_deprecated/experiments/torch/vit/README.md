...
```bash
python3 blacksmith_deprecated/experiments/torch/vit/train.py --config blacksmith_deprecated/experiments/torch/vit/single_chip/vit_stanfordcars.yaml
```
...
| `project_dir` | Directory for experiment outputs. | "blacksmith_deprecated/experiments/torch/vit" |
