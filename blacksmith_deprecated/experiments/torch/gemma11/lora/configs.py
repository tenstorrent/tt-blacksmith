...
from blacksmith_deprecated.tools.templates.configs import (
    TrainingConfig as BaseTrainingConfig,
)
from blacksmith_deprecated.tools.test_config import TestConfig
...
class TrainingConfig(BaseTrainingConfig):
    ...
    project_dir: str = Field(default="blacksmith_deprecated/experiments/torch/gemma11")
