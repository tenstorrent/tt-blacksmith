...
**BH LoudBox Training:**
```bash
python3 blacksmith_deprecated/experiments/torch/gemma4/train.py --config blacksmith_deprecated/experiments/torch/gemma4/lora/loudbox/gemma4_e2b_wizardlm.yaml
```
...
| `project_dir` | Directory for experiment outputs. | `"blacksmith_deprecated/experiments/torch/gemma4/xla"` |
