...
from blacksmith_deprecated.datasets.torch.dataset_utils import get_dataset
from blacksmith_deprecated.experiments.torch.gemma4.configs import TrainingConfig
from blacksmith_deprecated.models.torch.gemma4.model_overrides import (
    get_model,
    get_vocab_size,
)
from blacksmith_deprecated.tools.checkpoints_manager import CheckpointManager
from blacksmith_deprecated.tools.cli import generate_config, parse_cli_options
from blacksmith_deprecated.tools.device_manager import DeviceManager
from blacksmith_deprecated.tools.logging_manager import TrainingLogger
from blacksmith_deprecated.tools.reproducibility_manager import ReproducibilityManager
from blacksmith_deprecated.tools.torch_helpers import (
    collate_fn_for_causal_lm,
    collect_examples,
    show_examples,
)
from blacksmith_deprecated.tools.workaround_utils import (
    cross_entropy_loss,
    transform_labels,
)
...
def train(
    ...
    model = get_model(config, device_manager)
...
if __name__ == "__main__":
    default_config = Path(__file__).parent / "lora" / "loudbox" / "gemma4_e2b_wizardlm.yaml"
