...
**Precompute (run once):**
```bash
python3 blacksmith_deprecated/experiments/torch/wan2_2/precompute.py --config blacksmith_deprecated/experiments/torch/wan2_2/lora/quietbox/wan2_2_ti2v_5b_diffusiondb.yaml
```

**Train:**
```bash
python3 blacksmith_deprecated/experiments/torch/wan2_2/train.py --config blacksmith_deprecated/experiments/torch/wan2_2/lora/quietbox/wan2_2_ti2v_5b_diffusiondb.yaml
```
...
| `project_dir` | Directory for checkpoints/outputs. | `"blacksmith_deprecated/experiments/torch/wan2_2"` |
