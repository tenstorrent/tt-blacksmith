...
from blacksmith_deprecated.datasets.torch.diffusiondb_pixelart.diffusiondb_pixelart_dataset import (
    PixelArtLatentDataset,
    make_collate_fn,
)
from blacksmith_deprecated.experiments.torch.wan2_2.configs import TrainingConfig
from blacksmith_deprecated.experiments.torch.wan2_2.generate import (
    build_pipeline_for_validation,
    generate_validation_sample,
    generate_wan_video,
)
from blacksmith_deprecated.models.torch.wan2_2.device import WanDeviceManager
from blacksmith_deprecated.models.torch.wan2_2.model_overrides import (
...
if __name__ == "__main__":
    ...
    if config.use_tt:
        ...
        torch_xla.set_custom_compile_options(device_manager.xla_compile_options | compile_options)
