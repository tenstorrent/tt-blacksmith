...
- **Linear model** (`MNISTLinear`) - A simple fully-connected network from `tt-blacksmith/blacksmith_deprecated/models/torch/mnist/mnist_linear.py`

For CNN-based MNIST training, see [`blacksmith_deprecated/experiments/torch/mnist_cnn/`](../mnist_cnn/README.md).
...
```bash
python blacksmith_deprecated/experiments/torch/mnist/train.py
```
...
```bash
python blacksmith_deprecated/experiments/torch/mnist/data_parallel/train.py
```
...
```bash
python blacksmith_deprecated/experiments/torch/mnist/tensor_parallel/train.py
```
...
1. Single chip - Linear - `blacksmith_deprecated/experiments/torch/mnist/single_chip/mnist.yaml`
2. Data parallel - `blacksmith_deprecated/experiments/torch/mnist/data_parallel/mnist_dp.yaml`
3. Tensor parallel - `blacksmith_deprecated/experiments/torch/mnist/tensor_parallel/mnist_tp.yaml`

### Linear Model Configuration

In `blacksmith_deprecated/experiments/torch/mnist/single_chip/mnist.yaml` you can change default values for following parameters.
...
| `project_dir` | Project directory path. | "blacksmith_deprecated/experiments/torch/mnist" |
