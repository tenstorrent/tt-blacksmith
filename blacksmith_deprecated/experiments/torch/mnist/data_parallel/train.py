...
from blacksmith_deprecated.experiments.torch.mnist.configs import TrainingConfig
from blacksmith_deprecated.experiments.torch.mnist.data_parallel.utils import mse_loss
from blacksmith_deprecated.models.torch.mnist.mnist_linear import MNISTLinear
...
if __name__ == "__main__":
    # Generate config
    default_config = Path(__file__).parent / "mnist_dp.yaml"
