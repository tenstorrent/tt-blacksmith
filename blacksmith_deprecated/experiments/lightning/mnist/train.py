...
from blacksmith_deprecated.experiments.lightning.mnist.configs import ExperimentConfig
from blacksmith_deprecated.models.torch.mnist.mnist_linear import MNISTLinear
from blacksmith_deprecated.tools.cli import generate_config
from blacksmith_deprecated.tools.forge_tooling import disable_forge_logger
from blacksmith_deprecated.tools.torch_lightning import (
    GradientCheckpoint,
...
def test_training():
    ...
    config: ExperimentConfig = generate_config(
        ExperimentConfig, "blacksmith_deprecated/experiments/lightning/mnist/mnist.yaml"
    )
