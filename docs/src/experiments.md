...
| JAX | MLP | MNIST | Full-model, Data parallel | WH Galaxy | Not yet in main, but [working fine](https://wandb.ai/tenstorrent-ml/DP%20-%20Pure%20JAX%20MLP%20training/runs/r2tfckk9?nw=nwuserpglusac) |
